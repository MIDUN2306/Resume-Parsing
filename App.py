...
###### Packages Used ######
import streamlit as st # core  used in this project
import pandas as pd
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Midun@2306',db='cv')
...
st.set_page_config(
   ...
   page_icon='./Logo/Logo_resume.jpg',
)
...
def run():
    ...
    img = Image.open('./Logo/resume_title.png')
    st.image(img)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Midun</a> through 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == '12345':
                ...
                st.success("Welcome Midun ! Total %d " % values + " User's Have Used Our Tool : )")                
